        ...
        void p_DoubleClick(object sender, EventArgs e)
        {
            if (currentManipulatedElectrode != null)
            {
                ...
                else
                {
                    ...
                    m_map.hierarchicalModality.SetNextRealValue(new float[] { xPos / (float)m_map.Width, yPos / (float)m_map.Height, zPos / (float)m_map.Layers });
